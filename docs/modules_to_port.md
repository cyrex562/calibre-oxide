...
- [ ] kern.py (issue #552, now also owns HorizontalHeader/VerticalHeader from head.py)
...
- [ ] metrics.py (issue #552, now also owns HorizontalHeader/VerticalHeader from head.py)
