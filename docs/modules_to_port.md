...
- [ ] cdb.py (partial -- delete-books, set-cover, set-fields, add-book (issue #424 closed, real metadata sniffing + duplicate detection); no generic cmd dispatcher or copy-to-library; see `calibre_srv::cdb`'s module doc; remainder tracked by issues #425/#426)
