...
mod tests {
    ...
    fn test_app() -> (tempfile::TempDir, crate::AppState, axum::Router) {
        ...
        let state = crate::AppState {
            ...
            conversion_jobs: Arc::new(crate::convert::ConversionJobRegistry::new()), news_jobs: Arc::new(crate::news::NewsJobRegistry::new()), tweak_sessions: std::sync::Arc::new(crate::tweak::TweakSessionRegistry::new()), news_schedules: std::sync::Arc::new(crate::news_scheduler::NewsScheduleStore::new_in_memory().unwrap()),
        };
