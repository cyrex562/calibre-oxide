...
mod tests {
    ...
    fn test_app(tts_voice: Option<super::TtsVoiceConfig>) -> (tempfile::TempDir, axum::Router) {
        ...
        let state = crate::AppState {
            ...
            tts_voice: tts_voice.map(std::sync::Arc::new), plugin_store: None, plugin_registry: std::sync::Arc::new(std::sync::Mutex::new(calibre_customize::registry::PluginRegistry::new())),
        };
